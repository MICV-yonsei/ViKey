"""
ViKey Stage 2: keyword extraction for LongVideoBench.
...
``parsed_query`` field. The output JSONL is consumed by
``run_longvideobench.py`` for Keyword-Frame Mapping.
...
INSTRUCTION_EXAMPLES = (
    ...
    'Your Answer: ["gentleman wearing a shirt with pink floral patterns is speaking", "becoming friends with the unicorn"]\n'
    ...
    'Your Answer: ["man in gray-black clothes standing", "a red door and wall on the left, and a silver-white window and yellow wall on the right"]\n'
)
