"""
ViKey Stage 2: keyword extraction for Video-MME.
...
``parsed_query`` field. The output JSONL is consumed by ``run_videomme.py``
...
INSTRUCTION_EXAMPLES = (
    ...
    'Your Answer: ["the zodiacal light"]\n'

    'Example 2:\n'
    'Question: Which GPT is introduced after Convert Anything?\n'
    'Your Answer: ["Convert Anything"]\n'
