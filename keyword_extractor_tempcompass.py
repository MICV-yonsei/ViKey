"""
ViKey Stage 2: keyword extraction for TempCompass.
...
``run_tempcompass.py`` for Keyword-Frame Mapping.
...
INSTRUCTION_EXAMPLES = (
    'Example 1:\n'
    'Question: Which sentence better captures the essence of the video?\n'
    'Your Answer: []\n'

    'Example 2:\n'
    'Question: Which description is a more suitable match for the video?\n'
    'Your Answer: []\n'
)
